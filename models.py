...
class Generator(nn.Module):
    def __init__(self, in_channels=3, features=32):
        ...
        self.down4 = DownConv(features * 8, features * 8, kernel_size=4, stride=2, padding=1, batch=False)
        self.down5 = DownConv(features * 8, features * 8, kernel_size=4, stride=2, padding=1, batch=False)
        self.down6 = DownConv(features * 8, features * 8, kernel_size=4, stride=2, padding=1, batch=False)
        self.middle = DownConv(features * 8, features * 8, kernel_size=4, stride=2, padding=1, norm=False, batch=False, activation=True, leaky=False)

        self.up0 = UpConv(features * 8, features * 8, kernel_size=4, stride=2, padding=1, batch=False, dropout=True)
        self.up1 = UpConv(features * 8 * 2, features * 8, kernel_size=4, stride=2, padding=1, batch=False, dropout=True)
        self.up2 = UpConv(features * 8 * 2, features * 8, kernel_size=4, stride=2, padding=1, batch=False, dropout=True)
        self.up3 = UpConv(features * 8 * 2, features * 8, kernel_size=4, stride=2, padding=1, batch=False)
        self.up4 = UpConv(features * 8 * 2, features * 4, kernel_size=4, stride=2, padding=1, batch=False)
        self.up5 = UpConv(features * 4 * 2, features * 2, kernel_size=4, stride=2, padding=1, batch=False)
        self.up6 = UpConv(features * 2 * 2, features, kernel_size=4, stride=2, padding=1, batch=False)
        self.up7 = UpConv(features * 2, in_channels, kernel_size=4, stride=2, padding=1, norm=False, batch=False, activation=False)
